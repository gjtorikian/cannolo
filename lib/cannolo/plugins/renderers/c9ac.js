 ...
 *  ##### Example
 *
 *      Cannolo.render('c9ac', ast, options, function (err) {
 *        // ...
 *      });
 *
 *
...
module.exports = function (Cannolo) {
  Cannolo.registerRenderer('c9ac', function render_json(ast, _options, callback) {
    options = _options;
...
function extractItem(item, results) {
    ...
    if (item.inheritedFrom !== undefined) {
        return;
    }
